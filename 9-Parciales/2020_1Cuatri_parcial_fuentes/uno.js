...
function mostrar() {
    ...
    // b) Del tipo con mas unidades, el promedio por compra
    //sacar el mayor de alcohol
    if (acumuladorAlcohol > acumuladorBarbijo && acumuladorAlcohol > acumuladorJabon) {
        masUnidades = "Alcohol";
        promedioCompras = acumuladorAlcohol / contadorAlcohol;

    }
    else {
        //sacar  el mayuor  de jabon
        if (acumuladorJabon > acumuladorBarbijo && acumuladorJabon > acumuladorAlcohol) {
            masUnidades = "Jabon";
            promedioCompras = acumuladorJabon / contadorJabon;


        }
        else {
            //sacar el mayor de Barbijo
            if (acumuladorBarbijo > acumuladorJabon && acumuladorBarbijo > acumuladorAlcohol) {
                masUnidades = "Barbijo";
                promedioCompras = acumuladorBarbijo / contadorBarbijo;
            }
        }
    }
    ...
    alert("Unidades  total de Janbones  " + acumuladorJabon);
}
